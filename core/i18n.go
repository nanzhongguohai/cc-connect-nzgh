...
const (
	...
	MsgCardTitleWorkspace        MsgKey = "card_title_workspace"
	...
	MsgWsPickerBindBtn         MsgKey = "ws_picker_bind_btn"
	MsgWsPickerCurrentBtn      MsgKey = "ws_picker_current_btn"
)
...
var messages = map[MsgKey]map[Language]string{
	...
	MsgCardTitleWorkspace: {
		LangEnglish: "Workspace", LangChinese: "工作区", LangTraditionalChinese: "工作區",
		LangJapanese: "ワークスペース", LangSpanish: "Workspace",
	},
	MsgListItem: {
	...
	MsgWsPickerEmpty: {
		LangEnglish:            "No workspace folders found.",
		LangChinese:            "未找到可绑定的工作区目录。",
		LangTraditionalChinese: "未找到可綁定的工作區目錄。",
		LangJapanese:           "バインド可能なワークスペースディレクトリが見つかりません。",
		LangSpanish:            "No se encontraron carpetas de workspace.",
	},
	MsgWsPickerHint: {
		LangEnglish:            "Tap a folder to bind this channel. Source: `%s`",
		LangChinese:            "点击目录即可绑定当前频道。来源目录: `%s`",
		LangTraditionalChinese: "點擊目錄即可綁定目前頻道。來源目錄: `%s`",
		LangJapanese:           "フォルダをタップするとこのチャンネルにバインドされます。取得元: `%s`",
		LangSpanish:            "Toca una carpeta para vincular este canal. Origen: `%s`",
	},
	MsgWsPickerBindBtn: {
		LangEnglish:            "Bind",
		LangChinese:            "绑定",
	...
	MsgWsPickerCurrentBtn: {
		LangEnglish:            "Current",
		LangChinese:            "当前",
		LangTraditionalChinese: "目前",
		LangJapanese:           "現在",
		LangSpanish:            "Actual",
	},
}
